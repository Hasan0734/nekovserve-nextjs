...
const NekoElement = () => {
    return (
        <>
            <section className="neko-elements">
                    ...
                    <div className="container">
                        <div className="row text-center text-white">
                            <div className="col-12 col-md-4 mb-5">
                                <img src="./image//neko-element/frame1.png" style="max-width: 60%;" alt="" loading="lazy"/>
                            ...
                            <div className="col-12 col-md-4 mb-5">
                                <div className="mt-0 pt-0 mt-md-5 pt-md-5">
                                    <img src="./image/neko-element/frame2.png" style="max-width: 60%;" alt=""loading="lazy"/>
                            ...
                            <div className="col-12 col-md-4 mb-5">
                                <img src="./image/neko-element/frame3.png" style="max-width: 60%;" alt="" loading="lazy"/>
